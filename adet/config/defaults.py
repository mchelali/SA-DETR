...
_C.MODEL.TRANSFORMER.STRIDES = [8, 16, 32, 64]
_C.MODEL.TRANSFORMER.NUM_POINTS = 25  # the number of point queries for each instance
_C.MODEL.TRANSFORMER.VOC_SIZE = 37
_C.MODEL.TRANSFORMER.TEMPERATURE = 10000

_C.MODEL.TRANSFORMER.LANGUAGE = CN()
_C.MODEL.TRANSFORMER.LANGUAGE.CLASSES = [
    "Arabic",
    "Bangla",
    "Chinese",
    "Hindi",
...
_C.MODEL.TRANSFORMER.LANGUAGE.VOC_SIZES = [
    ("Arabic", 72),
    ("Bangla", 109),
    ("Chinese", 5197),
    ("Hindi", 107),
